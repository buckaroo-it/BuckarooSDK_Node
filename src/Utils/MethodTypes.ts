...
type InstanceWithManualFlag<Method, Manually extends boolean> = Manually extends true ? Method & { _isManually: Manually } : Method;
...
export type PaymentMethodInstanceType<Code extends ServiceCode, Manually extends boolean = false> = InstanceWithManualFlag<
...
export function getMethod<Code extends ServiceCode, Manually extends boolean>(code: Code): PaymentMethodInstanceType<Code, Manually> {
