...
export const Pay = (data:IPay) => {
    return   {
        ...
        phone: new ServiceParameters(data.phone).setGroupType('Phone').setParameterKeys({mobile:'Phone'}),
        ...
        address: new ServiceParameters(data.address)
        ...
        subTotals: new ServiceParameters(data.subTotals).setGroupType('SubtotalLine').makeCountable(),
    }
}