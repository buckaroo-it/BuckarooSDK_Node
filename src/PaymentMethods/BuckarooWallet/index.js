...
var Buckaroowallet = /** @class */ (function (_super) {
    ...
    Buckaroowallet.prototype.create = function (payload) {
        this.action = 'Create';
        return this.dataRequest();
    };
    Buckaroowallet.prototype.update = function (payload) {
        this.action = 'Update';
        return this.dataRequest();
    };
    Buckaroowallet.prototype.getinfo = function (payload) {
        this.action = 'Getinfo';
        return this.dataRequest();
    };
    Buckaroowallet.prototype.release = function (payload) {
        this.action = 'Release';
        return this.dataRequest();
    };
