...
describe('testing Ideal methods', function () {
    test('Issuers', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, ideal.issuers().then(function (response) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, ideal.pay().then(function (data) {
    ...
    test('Refund', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, create_ideal_Refund().then(function (data) {
                        expect(data).toBeDefined();
                    })];
                case 1:
                    _a.sent();
    ...
    test('Specifications', function () { return __awaiter(void 0, void 0, void 0, function () {
        var idealSpecifications;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, ideal.specification()];
                case 1:
                    idealSpecifications = _a.sent();
...
var transactionKey = '97DC0A03BBDF4DAAAC694D7FEC8785E1';
...
//# sourceMappingURL=Ideal.test.js.map