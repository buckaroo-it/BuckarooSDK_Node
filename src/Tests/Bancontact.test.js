...
var method = (0, Bancontact_1.default)();
describe('testing methods', function () {
    ...
    test('Authenticate', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, method.authenticate({ amountDebit: 10 }).then(function (data) {
                        console.dir(data);
                        expect(data).toBeDefined();
                    })];
                case 1:
    ...
    test('PayOneClick', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, method
                        .payOneClick({
    ...
    test('CompletePayment', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, method
                        .completePayment({
    ...
    test('PayRecurring', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, method
                        .payRecurring({
...
//# sourceMappingURL=Bancontact.test.js.map